...
if(!defined('BOOTSTRAP_LOADED')){
	...
	$mcFileManagerConfig['preview.urlprefix'] = "{proto}://{host}".WWW_ROOT; // domain name
	...
	$mcFileManagerConfig['filesystem.path'] = FILE_ROOT; // absolute or relative from this script path.
	$mcFileManagerConfig['filesystem.rootpath'] = FILE_ROOT."uploads".DS."editor".DS; // absolute or relative from this script path.
	...
	$mcFileManagerConfig['SessionAuthenticator.logged_in_key'] = "id";
	$mcFileManagerConfig['SessionAuthenticator.groups_key'] = "groups";
	$mcFileManagerConfig['SessionAuthenticator.user_key'] = "username";
	$mcFileManagerConfig['SessionAuthenticator.path_key'] = "SESS_AD_STORE";
